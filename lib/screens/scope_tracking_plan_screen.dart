...
class _ScopeTrackingHeader extends StatelessWidget {
  const _ScopeTrackingHeader({required this.onBack, required this.onForward});
...
class _ScopeMetricRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Wrap(
      ...
      children: const [
        _ScopeMetricCard(
            label: 'Baseline Items', value: '42', accent: Color(0xFF2563EB)),
        _ScopeMetricCard(
            label: 'Open Changes', value: '7', accent: Color(0xFFF59E0B)),
        _ScopeMetricCard(
            label: 'Approved Variance',
            value: '+6%',
            accent: Color(0xFF10B981)),
        _ScopeMetricCard(
            label: 'Next Review', value: 'Oct 18', accent: Color(0xFF8B5CF6)),
      ],
    );
  }
}
